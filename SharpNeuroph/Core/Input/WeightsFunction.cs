...
namespace Neuroph.Core.Input
{
    ...
    public abstract class WeightsFunction
    {
        ...
        /// <returns>function's output</returns>
        abstract public double[] CalculateOutput(IList<Connection> inputConnections);
        
        abstract public double[] CalculateOutput(double[] inputs, double[] weights);
